    ...
    setMessages((prev) =>
      prev.map((msg) =>
        msg.id === msgId
          ? {
            ...msg,
            feedback: msg.feedback === feedback ? undefined : feedback,
          }
          : msg,
      ),
    );
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            ...
            <motion.div
              layout
              className={`p-4 pb-32 flex-1 overflow-y-auto flex flex-col gap-4 ${isFullScreen ? "bg-white px-4 sm:px-8" : "bg-[#F9F9F8]"}`}
            >
              <div
            ...
            >
              ...
              <div
                className={`relative flex items-end gap-0 p-1.5 rounded-[24px] mx-auto w-full ${isFullScreen ? "max-w-3xl bg-[#F0F4F9] shadow-none" : "max-w-4xl bg-white border border-[#E8E8E5] shadow-md"}`}
              >
