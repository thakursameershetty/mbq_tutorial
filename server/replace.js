const fs = require('fs');
const file = '/Users/thakur/Desktop/Sample/mbq_tutorial/server/mailer.js';
let content = fs.readFileSync(file, 'utf8');

const htmlContent = `  const mailOptions = {
...
<body>
  <div class="container">
    <div class="header">
      <img src="https://mbq-tutorial.vercel.app/favicon.svg" alt="MyBodyQode Logo" width="48" height="48">
      <h1 style="color: #1A1A19; font-size: 20px; margin-top: 10px; font-weight: 800; letter-spacing: -0.5px;">MyBodyQode</h1>
    </div>
    <div class="content">
...
content = content.replace(/  const mailOptions = \{[\s\S]*?Educational and non-diagnostic wellness insights only\.<\/p>\n      <p>&copy; 2026 MyBodyQode\. All rights reserved\.<\/p>\n    <\/div>\n  <\/div>\n<\/body>\n<\/html>`\n  };/, htmlContent);
